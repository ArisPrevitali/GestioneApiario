...
<header class="head">
    ...
    <div class="body">
        <h1 class="title center">Gestione Apiario - Aggiungi Nota</h1>
        <div class="table-wrapper">
            <table class="table">
            <?php $id = $_SESSION['id_arnia_trattamento']; ?>
                <form action="<?php if($_SESSION['loggedUser']): echo 'PHP/addNota.php?id='.$id; endif ?>" method="POST" class="float-left center">
                    <p>Data</p>
